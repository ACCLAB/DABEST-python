...
def mean_difference(x1, x2=None, paired=False):
    ...
    es = namedtuple('EffectSize', ['mean_diff', 'cohens_d', 'hedges_g'])
...
# def cohens_d(control, test, bias_correction=True):
#     """
#     Computes Cohen's d for 2 samples.
#
#     Keywords
#     --------
#     control, test: numeric iterables.
...
#         If True, applies Hedges and Olkin's correction factor.
#         See https://en.wikipedia.org/wiki/Effect_size#Hedges'_g
#
#
#     Returns
...
#     test_mean = test.mean()
#
#     pooled_sd = __pooled_sd(control, test)
#
#     biased_g = (test_mean - control_mean) / pooled_sd
#
#     correction_factor = __hedges_correction_factor(control_n + test_n - 2)
#
#     biased_corrected_g = correction_factor * biased_g
#
#     if bias_correction is True:
#         return biased_corrected_g
#
#     else:
#         return biased_g
