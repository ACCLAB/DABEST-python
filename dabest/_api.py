...
def load(data, idx, x=None, y=None, paired=False, repeated_measures=None, id_col=None,
    ...
    return Dabest(data, idx, x, y, paired, repeated_measures, id_col, ci, resamples, random_seed)
